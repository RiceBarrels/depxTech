...
export default function Trade() {
  const tradableItems = (
    <motion.div 
      className="flex justify-center items-center flex-col m-2 md:flex-row md:flex-wrap md:justify-start"
  ...
  return (
    <>
      <motion.div 
        className="w-full mx-auto h-[50vh] md:h-[65vh] overflow-hidden background-card rounded-b-xl"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
     ...
     <motion.h1 
        className="text-2xl md:text-6xl m-6"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
